...
cfg_if::cfg_if!(
    ...
    } else if #[cfg(target_os = "windows")] { /*https://download.microsoft.com/download/1/6/1/161ba512-40e2-4cc9-843a-923143f3456c/scancode.doc*/
        pub mod Scancodes {
            ...
            pub const SEMICOLON: u32 = 0x27; //idk
            ...
            pub const LALT: u32 = 0xE2;
            pub const SPACE: u32 = 0x2C;
            pub const CTRL: u32 = 0xE0;
            pub const E: u32 = 0x08;
            pub const PLUS_NUM: u32 = 0x57;
            pub const MINUS_NUM: u32 = 0x56;
            pub const UP: u32 = 0x60;
            pub const DOWN: u32 = 0x5A;
            pub const LEFT: u32 = 0x5C;
            pub const RIGHT: u32 = 0x5E;
            pub const I: u32 = 0x0C;
